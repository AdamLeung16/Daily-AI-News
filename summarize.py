...
3. 重点关注 OpenAI、Google DeepMind/Google、Anthropic、Meta、Microsoft、NVIDIA、Amazon/AWS、Apple 等公司的模型、产品、平台、芯片、Agent、多模态、企业 AI 和安全治理动态。
...
def _compact_sources(sources: dict[str, Any]) -> str:
    payload = {
        "company_updates": sources.get("company_updates", [])[:30],
...
# 今日 AI 技术总览
# 大公司技术成果与突破动态
选 5–8 条，覆盖 OpenAI、Google/DeepMind、Anthropic、Meta、Microsoft、NVIDIA、Amazon/AWS、Apple 等。每条包含：公司/来源、标题链接、发生了什么、为什么重要。
# 今日 AI 热点新闻
